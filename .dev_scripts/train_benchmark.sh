...
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=$CPUS_PRE_TASK ./tools/slurm_train.sh $PARTITION atss_base configs/atss/atss_base.py $WORK_DIR/atss_base --cfg-options default_hooks.checkpoint.max_keep_ckpts=1 &
...
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=$CPUS_PRE_TASK ./tools/slurm_train.sh $PARTITION ddod_r50_fpn_1x_coco configs/ddod/ddodconfig.py $WORK_DIR/ddod_r50_fpn_1x_coco --cfg-options default_hooks.checkpoint.max_keep_ckpts=1 &
...
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=$CPUS_PRE_TASK ./tools/slurm_train.sh $PARTITION tood_base configs/tood/tood_base.py $WORK_DIR/tood_base --cfg-options default_hooks.checkpoint.max_keep_ckpts=1 &
