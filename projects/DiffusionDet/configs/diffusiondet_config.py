...
test_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='F:/mmdetection-main/cocoOptics2coco/annotations/instances_val2017.json',
        backend_args=None,
        data_prefix=dict(img='val2017/'),
        data_root='F:/mmdetection-main/cocoOptics2coco/images/',
        pipeline=[
            dict(
                backend_args=None,
...
train_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='F:/mmdetection-main/cocoOptics2coco/annotations/instances_train2017.json',
        backend_args=None,
...
work_dir = './work_dirs\\diffusiondet_base'
